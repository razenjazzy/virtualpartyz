...
@media (min-width: 768px) and (max-width: 979px) {
	#site-header .header-main:not(.header-layout-fullwidth_hamburger):not(.header-layout-perspective) .site-title,
	#site-header .header-main:not(.header-layout-fullwidth_hamburger):not(.header-layout-perspective) .primary-navigation,
	#site-header .header-main:not(.header-layout-fullwidth_hamburger):not(.header-layout-perspective) #perspective-menu-buttons {
		display: block;
		text-align: center;
	}
	#site-header .header-main:not(.header-layout-fullwidth_hamburger):not(.header-layout-perspective):not(.logo-position-menu_center) .site-title {
		padding-top: 30px;
		padding-bottom: 0;
	}
	#site-header .header-main:not(.header-layout-fullwidth_hamburger):not(.header-layout-perspective).logo-position-right .site-title {
		padding-top: 0;
		padding-bottom: 30px;
	}
	#site-header.fixed.shrink .header-main:not(.header-layout-fullwidth_hamburger):not(.header-layout-perspective) .site-title {
		display: none;
	}
	#site-header .site-title a img.small {
		display: none !important;
