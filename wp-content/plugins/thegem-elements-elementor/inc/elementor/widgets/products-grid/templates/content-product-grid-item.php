		...
		<div class="wrap clearfix">
									...
									<div class="portfolio-icons-inner clearfix">
										...
										<a href="<?= esc_url(get_the_permalink()); ?>"
										   class="icon product-page bottom-product-link">
											<?php if ($settings['hover_icon_product-page']['value']) {
			...
			<div class="product-labels">
				...
				<?php if ($settings['product_show_new'] == 'yes' && $product->is_featured()) : ?>
					<?php echo apply_filters('woocommerce_featured_flash', '<span class="new-label title-h6"><span class="rotate-back"><span class="text">' . $settings['new_label_text'] . '</span></span></span>', $post, $product); ?>
				<?php endif; ?>
				<?php if ($settings['product_show_out'] == 'yes' && !$product->is_in_stock()) : ?>
					<?php echo apply_filters('woocommerce_out_of_stock_flash', '<span class="out-of-stock-label title-h6"><span class="rotate-back"><span class="text">' . $settings['out_label_text'] . '</span></span></span>', $post, $product); ?>
				<?php endif; ?>
			</div>
		</div>
	</div>
