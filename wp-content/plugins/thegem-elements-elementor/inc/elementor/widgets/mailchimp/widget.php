...
//				'default' => 'left',
	...
	protected function render() {
		...
		if ($settings['disable_inline_mobile'] && $settings['disable_inline_mobile'] == 'yes') {
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new TheGem_Mailchimp());