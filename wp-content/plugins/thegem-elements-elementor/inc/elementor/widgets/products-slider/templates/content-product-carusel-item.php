	...
	<div class="wrap clearfix">
		...
		<div class="product-labels">
			...
			<?php if ($settings['products_show_new_label'] == 'yes' && $product->is_featured()) : ?>
				<?php echo apply_filters('woocommerce_featured_flash', '<span class="new-label title-h6"><span class="rotate-back"><span class="text">' . $settings['products_text_new_label'] . '</span></span></span>', $post, $product); ?>
			<?php endif; ?>
			<?php if ($settings['products_show_out_label'] == 'yes' && !$product->is_in_stock()) : ?>
				<?php echo apply_filters('woocommerce_out_of_stock_flash', '<span class="out-of-stock-label title-h6"><span class="rotate-back"><span class="text">' . $settings['products_text_out_label'] . '</span></span></span>', $post, $product); ?>
			<?php endif; ?>
		</div>
	</div>
</div>
